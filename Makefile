...
all: directories ode_compiler ode_shell
...
ode_shell: src/ode_shell.c code_converter.o parser.o lexer.o ast.o token.o file_utils.o sds.o commands.o string_utils.o
	gcc -g src/ode_shell.c build/parser.o build/lexer.o build/ast.o build/token.o build/file_utils.o build/sds.o build/code_converter.o build/string_utils.o build/commands.o -o bin/ode_shell -lreadline
...
commands.o: ${COMMANDS}
	gcc -g -c  src/commands.c -o  build/commands.o

string_utils.o: ${STR_UTILS}
	gcc -g -c  src/string_utils.c -o  build/string_utils.o
